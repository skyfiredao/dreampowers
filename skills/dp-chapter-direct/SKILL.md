...
- **节奏控制**：微观节奏（句子、段落、对话密度、micro-tension）和宏观张力弧线（幕级/全篇张力走势、赌注升级、高潮铺垫）
...
| 子模式 | 激活条件 | 典型任务 | 节奏基调 |
|-------|---------|---------|---------|
| 动作模式 (Action Mode) | 存在明显物理冲突、追逐、战斗、逃亡 | 夺取、压制、突围、生还 | 快 |
| 情感模式 (Emotional Mode) | 告白、失去、关系转折、情绪摊牌 | 暴露或压抑真实情绪 | 慢 |
| 对白模式 (Dialogue Mode) | 谈判、审问、辩论、信息交换、社交博弈 | 争夺话语权与信息优势 | 中 |
...
|----|---------|---------------|
| 架 | Setup | 环境、站位、赌注 |
| 動 | Movement | 位移、换位、距离变化 |
| 招 | Technique | 具体动作、技能、战术 |
| 勢 | Momentum | 优劣转换、战局倾斜 |
| 心 | Psychology | 恐惧、决心、计算、误判 |
...
3. 对白模式中的描写技法仅用于叙事打断（连续对话最多 5 轮后的插入），不可喧宾夺主。
...
硬性规则：**纯对话超过 5 个来回，必须插入动作或叙述打断**。连续对话让场景失去空间感和身体感，变成两个悬浮的声音。
...
- 正确的节奏波形：张→张→张→弛→张→张→弛（而非 张张张张张弛弛弛弛弛）
...
| 症状 | 可能原因 | 修复方向 |
|------|---------|---------|
| 读者想跳过段落 | 节奏过慢，或内容缺乏 micro-tension | 缩短段落，增加微张力 |
| 读者感到困惑 | 节奏过快，新信息没有处理时间 | 增加过渡句，减少信息密度 |
| "什么都没发生" | 场景缺乏 micro-tension | 注入小冲突、未解决的问题 |
...
即使在"慢"场景中，每一段都需要微张力：一个小问题、一点分歧、一丝不确定、一个未满足的渴望。

微张力不是情节张力。不需要有人追杀主角。微张力可以是：
- 一句话里的潜台词（说的和想的不一样）
- 一个未说出口的问题
- 两个角色之间微妙的不同步
- 一个正在倒数的期限
...
**慢节奏 + 微张力 = 读者愿意逐字阅读的沉浸感。慢节奏 + 零张力 = 读者翻页跳过。**
...
本部分控制**宏观张力**：故事级和幕级的张力走势。第二部分处理微观张力（场景内的句子节奏、段落密度、micro-tension），本部分关注更高层面：整个故事的张力是否在持续攀升？每一幕的高潮是否比上一幕更猛？读者翻过一百页之后，赌注是否比开头大了十倍？
...
根据故事类型选择合适的宏观张力模型。不是死板套用，而是作为骨架参考。

### 经典三幕渐升

每一幕的高潮比上一幕更强烈。张力整体呈阶梯式上升。

适用：结构紧凑的中短篇，电影感强的叙事。每幕末尾的高潮是明确的"不可逆转折"。张力整体呈阶梯式上升，第一幕高潮 < 第二幕高潮 < 终幕高潮。
...
适用：多线叙事、群像小说、有复杂人物关系的故事。两条线在终幕汇合，产生叠加冲击。
...
| 协作 | `dp-set-outline` | 在大纲阶段调用本技能规划全篇张力走势；大纲中已规划的节奏弧线（高潮/低谷标注）作为本技能的输入 |
...
**微观节奏反模式：**
- **长段"什么都没发生"** ❌ 没有 micro-tension 的慢场景不是"节奏舒缓"，是"节奏停滞"
...
**宏观张力反模式：**
- **全程高压不给喘息** ❌ 连续 2 章以上高张力（8+分），读者疲劳脱敏，高潮变成噪音
- **中段塌陷** ❌ 第二幕/卷中间大段张力平坦（连续 3 章变化不超过 1 分），读者流失的重灾区
...
| 对话超过 5 轮无叙事打断 | 节奏板结 | 插入动作节拍并重排交换次序 |
...
- 纯对话超过 5 个来回无动作/叙述打断 → 场景失去空间感
- 连续 3 个高张力场景无舒缓 → 张弛法则违规
- 舒缓场景中找不到任何 micro-tension → 节奏停滞
- 全章句子长度方差极小 → 缺乏节奏呼吸
...
**节奏控制：**
章节/场景的节奏经过诊断与调整，符合张弛法则，micro-tension 贯穿全文，句子和段落长度变化自然，节奏模式匹配场景情感需求。全篇张力弧线经过审计，赌注持续升级，张力曲线呈波浪式攀升，高潮章节的三项准备（宁静对比、多线汇合、伏笔收束）全部到位，张力追踪表填写完整且无 Red Flag。
